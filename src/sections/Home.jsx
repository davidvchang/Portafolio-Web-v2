        ...
        <div className='flex flex-col text-white'>
            <div className='flex flex-col gap-10'>
                ...
                <div className='flex items-center gap-7'>
                    <a href="" className='w-fit h-fit px-12 py-3 rounded-full font-medium bg-gradient-to-r from-teal-400 to-blue-500 text-white hover:brightness-95 hover:transition duration-300'>Ver CV</a>
