...
function Home() {
  return (
    <section className='flex flex-col-reverse 2xl:flex-row w-full h-[54rem] items-center justify-around'>
...
const iconViewCV = <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 w-6 h-6">
