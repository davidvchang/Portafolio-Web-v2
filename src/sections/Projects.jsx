...
import BlogSpace from '../assets/img/covers/BlogSpace.webp'
...
const Projects = () => {
  return (
    <section className='flex flex-col w-full text-white gap-16 pt-10' id='projects'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-1 md:justify-items-center lg:grid-cols-2 xl:grid-cols-3 gap-y-6 pb-10'>
            <ProjectCard image={BlogSpace} title="BlogSpace" description="Página en la cuál puedes ver todos los blogs que los usuarios han agregado, como también puedes registrarte, iniciar sesión y poder crear tus propios blogs, eliminarlos, editarlos y poder comentar otros blogs"
                children={
                    <>
                ...
                children2={
                    <>
                        <BtnActionsProjects link="https://github.com/davidvchang/BlogSpace" icon={<Github className='text-white w-5 h-5'/>} text="Ver repositorio"/>
