        ...
        <div className='flex flex-col text-white'>
            <div className='flex flex-col gap-10'>
                ...
                <div className='flex items-center gap-7'>
                    <a href="" className='w-fit h-fit px-12 py-3 rounded-full font-medium bg-gradient-to-r from-teal-400 to-blue-500 text-white hover:brightness-90 hover:transition duration-300'>Ver CV</a>
                    
                    <div className='flex gap-4'>
                        <SocialNetworkButton icon={<Github className='w-5 h-5'/>}/>
                        <SocialNetworkButton icon={<Linkedin className='w-5 h-5'/>}/>
                        <SocialNetworkButton icon={<Mail className='w-5 h-5'/>}/>
